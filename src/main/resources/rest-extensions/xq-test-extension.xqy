...
module namespace xq-test-extension =
  "http://marklogic.com/rest-api/resource/xq-test-extension";
...
(: Conventions: 
 ...
 : and function signatures must conform to xq-test-extensions below.
...
declare function xq-test-extension:get(
    $context as map:map,
    $params  as map:map
) as document-node()*
{
...
declare function xq-test-extension:put(
    $context as map:map,
    $params  as map:map,
...
declare function xq-test-extension:post(
    $context as map:map,
    $params  as map:map,
    $input   as document-node()*
) as document-node()*
...
declare function xq-test-extension:delete(
    $context as map:map,
    $params  as map:map
) as document-node()?
{
